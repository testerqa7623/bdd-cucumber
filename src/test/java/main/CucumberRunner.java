...
@CucumberOptions(strict = true, monochrome = true, features = "src/test/resources/features", glue = "stepdefinitions", format = {"pretty","json:target/cucumber.json"}, tags = { "@Regression" })
